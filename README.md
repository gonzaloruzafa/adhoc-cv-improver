...
Herramienta para analizar y mejorar CVs usando IA.

View your app in AI Studio: https://ai.studio/apps/drive/1-sBHl8tPgBd0oLgvIpY178Ooy5lR3I7M
...
- ✅ El frontend llama a `/api/analyze-cv` (tu servidor)
